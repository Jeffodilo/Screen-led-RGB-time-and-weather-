...
void messageReceived(String &topic, String &payload) {
  ...
  // gestion de l'extinction de l'écran, brightness = 1 = Screen ON
  ...
  // ligne de separation / Separate line
  ...
  else if (icon_index == "Drizzle" || icon_index == "Fog"){
  ...
  // Extinction écran la nuit, Screen Off the night
  else {
    display.clearDisplay();
  }
...
void setup() {
  ...
  // On éteinds l'écran pour éviter le scintillement pendant la mise à jour
  ArduinoOTA.onStart([]() {
      display.clearDisplay(); // avoid flickering during update
  ...
  // Récupération des valeurs au démarrage
  client.publish("afficheur/boot", "Start"); // Start value from node red at the starting
